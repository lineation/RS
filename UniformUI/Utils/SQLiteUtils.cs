...
namespace UniformUI.Utils
{
    public class SQLiteUtils
    {
        ...
        public static string connectionString = "Data Source=" + Environment.CurrentDirectory + "\\test1.db";
        #region 获取数据库连接
        /// <summary>
        /// 获取数据库连接
        /// </summary>
        ...
        public static SQLiteConnection GetConnection(string dbName)
        {
            ...
            {
                CloseDB(conn);
                throw new UserException("数据库打开异常！" + ex.Message);
            }
        }
        ...
        public static void CloseDB(SQLiteConnection conn) 
        {
            if (conn.State == ConnectionState.Connecting)
            {
                ...
                {
                    throw new UserException("数据库关闭异常！" + ex.Message);
                }
            }
        ...
        public static DataTable DataSourceBindToDataGridView(DataGridView dataGridView,
            ...
            string tableName)
        {
            SQLiteConnection conn = Utils.SQLiteUtils.GetConnection(dbName);
